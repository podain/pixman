...
PIXMAN_ARM_BIND_SCALED_BILINEAR (0, neon, 8888_n_8888, SRC,
                                         uint32_t, uint32_t, uint32_t, FALSE, FALSE)
PIXMAN_ARM_BIND_SCALED_BILINEAR (0, neon, 8888_n_0565, SRC,
                                         uint32_t, uint32_t, uint16_t, FALSE, FALSE)
PIXMAN_ARM_BIND_SCALED_BILINEAR (0, neon, 0565_n_x888, SRC,
                                         uint16_t, uint32_t, uint32_t, FALSE, FALSE)
PIXMAN_ARM_BIND_SCALED_BILINEAR (0, neon, 0565_n_0565, SRC,
                                         uint16_t, uint32_t, uint16_t, FALSE, FALSE)

PIXMAN_ARM_BIND_SCALED_BILINEAR (SKIP_ZERO_SRC, neon, 8888_n_8888, OVER,
                                         uint32_t, uint32_t, uint32_t, FALSE, FALSE)

PIXMAN_ARM_BIND_SCALED_BILINEAR (SKIP_ZERO_SRC, neon, 8888_n_8888, ADD,
                                         uint32_t, uint32_t, uint32_t, FALSE, FALSE)

PIXMAN_ARM_BIND_SCALED_BILINEAR (0, neon, 8888_8_8888, SRC,
                                         uint32_t, uint8_t, uint32_t, TRUE, FALSE)

PIXMAN_ARM_BIND_SCALED_BILINEAR (SKIP_ZERO_SRC, neon, 8888_8_8888, OVER,
                                         uint32_t, uint8_t, uint32_t, TRUE, FALSE)

PIXMAN_ARM_BIND_SCALED_BILINEAR (SKIP_ZERO_SRC, neon, 8888_8_8888, ADD,
                                         uint32_t, uint8_t, uint32_t, TRUE, FALSE)
...
static const pixman_fast_path_t arm_neon_fast_paths[] =
{
    ...
    SIMPLE_BILINEAR_FAST_PATH (SRC, a8r8g8b8, a8r8g8b8, neon_8888_n_8888),
    SIMPLE_BILINEAR_FAST_PATH (SRC, a8r8g8b8, x8r8g8b8, neon_8888_n_8888),
    ...
    SIMPLE_BILINEAR_FAST_PATH (SRC, r5g6b5, x8r8g8b8, neon_0565_n_x888),
    SIMPLE_BILINEAR_FAST_PATH (SRC, r5g6b5, r5g6b5, neon_0565_n_0565),

    SIMPLE_BILINEAR_FAST_PATH (OVER, a8r8g8b8, a8r8g8b8, neon_8888_n_8888),
    SIMPLE_BILINEAR_FAST_PATH (OVER, a8r8g8b8, x8r8g8b8, neon_8888_n_8888),

    SIMPLE_BILINEAR_FAST_PATH (ADD, a8r8g8b8, a8r8g8b8, neon_8888_n_8888),
    SIMPLE_BILINEAR_FAST_PATH (ADD, a8r8g8b8, x8r8g8b8, neon_8888_n_8888),
    ...
    SIMPLE_BILINEAR_A8_MASK_FAST_PATH (SRC, x8r8g8b8, a8r8g8b8, neon_8888_8_8888),
